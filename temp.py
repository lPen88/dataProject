...
# prova senza i campi relativi alla famiglia

df = pd.read_csv('dataset/train_processed.csv')

df=df.drop(columns=['FamilySize_0','FamilySize_1','FamilySize_2','FamilySize_3'])
...
test_df = test_df.drop(columns=['FamilySize_0','FamilySize_1','FamilySize_2','FamilySize_3'])
