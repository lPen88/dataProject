...
# Selezione delle feature legate allo stile di vita e comportamenti
lifestyle_features = [
    'Smoking', 'Obesity', 'Alcohol Consumption', 'Exercise Hours Per Week',
    'Physical Activity Days Per Week', 'Diet', 'Sleep Hours Per Day',
    'Sedentary Hours Per Day', 'Stress Level'
]
